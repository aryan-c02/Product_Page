    ...
    return (
        <div className="py-6 flex flex-col items-center justify-between gap-5 w-full mt-4 rounded-xl h-40 border border-[#E3E6EC]">
            <div className="w-10/12 flex justify-start">
                <button type="button" className="h-6 w-10/12 text-white bg-blue-700 hover:bg-blue-800  font-medium rounded-full text-sm  dark:bg-blue-600 dark:hover:bg-blue-700 uppercase ">Tracking Available</button>
            </div>
            ...
            <div className="w-10/12 flex gap-5 items-center ">
                ...
                <div className="font-normal text-base text-[#667385] mt-0.5 ">
